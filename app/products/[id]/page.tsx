...
export default async function ProductDetailPage({params}:Props){
  ...
  const photos:string[]=Array.isArray(product.photo_urls)&&product.photo_urls.length?product.photo_urls:(product.thumbnail_url?[product.thumbnail_url]:[]);
  return <main className="rc-product-page"><section className="rc-product-card">
    ...
    <div className="rc-product-grid">
      ...
      </div>{product.description&&<div className="rc-product-description">{product.description}</div>}
